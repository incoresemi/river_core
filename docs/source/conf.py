...
#!/usr/bin/env python
#
# river_core documentation build configuration file, created by
...
project = 'RiVer Core'
copyright = u'2019 InCore Semiconductors, IIT Madras'
...
version = river_core.__version__
# The full version, including alpha/beta/rc tags.
release = river_core.__version__
...
latex_documents = [
    (master_doc, 'river_core.tex',
     'RiVer Core Documentation',
